          ...
          {searchType === "attraction_plan" && attractionPlan ? (
            <>
              ...
              >
                ...
                {(() => {
                  if (
                    !attractionPlan.total_duration ||
                    typeof attractionPlan.total_duration !== "string"
                  )
                    return "N/A";
              ...
              {attractionPlan.itinerary.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      {(() => {
                        if (
                          ...
                          typeof item.suggested_duration !== "string"
                        )
                          return "N/A";
                    ...
                    <div>
                      📍 Distance:{" "}
                      {item.place.distance_from_start?.toFixed(2) || "N/A"}{" "}
                      miles
                    </div>
            ...
            searchResults.map((result, index) => (
              ...
              >
                ...
                >
                  <div>
                    📍 Distance: {result.distance?.toFixed(2) || "N/A"} miles
                  </div>
