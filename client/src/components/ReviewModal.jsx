      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', marginBottom: '8px', color: '#5f6368', fontWeight: '500' }}>
              Rating *
            </label>
            <div style={{ display: 'flex', gap: '8px' }}>
              ...
              {rating > 0 && (
                <span style={{ marginLeft: '12px', color: '#5f6368', fontSize: '14px', alignSelf: 'center' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <textarea
              ...
              maxLength={1000}
            />
            <div style={{ textAlign: 'right', fontSize: '12px', color: '#80868b', marginTop: '4px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            <button
              ...
              style={{
                ...
                fontSize: '14px',
                fontWeight: '500',
                cursor: isLoading || rating === 0 || !review.trim() ? 'not-allowed' : 'pointer',
